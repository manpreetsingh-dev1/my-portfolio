          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            ...
            <div>
              ...
              <h2 className="theme-text-primary mt-4 text-3xl font-semibold sm:text-4xl">
                View my resume for a quick overview of my stack and project work.
              </h2>

              <p className="theme-text-secondary mt-4 max-w-2xl text-base leading-7">
                If you are hiring for internships, entry-level roles, or freelance work,
                this gives a fast summary of my skills, tools, and current focus areas
